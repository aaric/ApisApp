...
public class GuidanceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViews.add(View.inflate(this, R.layout.activity_guidance_tab1, null));
        listViews.add(View.inflate(this, R.layout.activity_guidance_tab2, null));

        // Last view.
        View mViewWithButton = View.inflate(this, R.layout.activity_guidance_tab3, null);
